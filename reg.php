<?php
include __DIR__.'/../univ-1/app/database/db.php';
include __DIR__.'/../univ-1/app/controllers/users.php';
?>
  ...
  <body class="container">
    ...
    <form class="row justify-content-md-center" method="post" action="reg.php">
        ...
        <div class="mb-3 col-12 col-md-4">
            ...
            <input name="login" type="text" class="form-control" id="formGroupExampleInput" placeholder="">
          </div>
          <div class="w-100"></div>
        <div class="mb-3 col-12 col-md-4">
        ...
        <div class="mb-3 col-12 col-md-4">
          ...
          <div class="w-100"></div>
          <div class="mb-3 col-12 col-md-4">
            <button type="submit" class="btn btn-warning" name="button-reg">Войти</button>
